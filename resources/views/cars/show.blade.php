...
=======
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12" x-data="{ currentImage: 0, images: {{ json_encode($car['images']) }} }">
>>>>>>> ae3eca91d202169d17a06e35ad479d823d1102e2
            <!-- Gallery -->
            <div class="space-y-4">
...
=======
                        @if(isset($car['isHot']) && $car['isHot'])
                            <span class="bg-primary text-primary-foreground px-3 py-1 rounded-md text-xs font-bold uppercase tracking-wider">Hot</span>
                        @endif
                        @if(isset($car['discount']))
                            <span class="bg-green-600 text-white px-3 py-1 rounded-md text-xs font-bold uppercase tracking-wider">-{{ $car['discount'] }}%</span>
>>>>>>> ae3eca91d202169d17a06e35ad479d823d1102e2
                        @endif
                    </div>
...
<<<<<<< HEAD
                        ...
                        @endauth
=======
                        <button class="w-10 h-10 bg-background/80 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-background transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>
                        </button>
>>>>>>> ae3eca91d202169d17a06e35ad479d823d1102e2
                    </div>
...
=======
                        <span class="px-3 py-1 bg-secondary rounded-lg text-sm font-medium">{{ $car['brand'] }}</span>
                        <span class="text-muted-foreground">{{ $car['type'] }} • {{ $car['year'] }}</span>
                    </div>
                    <h1 class="text-3xl md:text-4xl font-bold mb-4">{{ $car['name'] }}</h1>
                    <p class="text-muted-foreground leading-relaxed">{{ $car['description'] }}</p>
>>>>>>> ae3eca91d202169d17a06e35ad479d823d1102e2
...
=======
                                <p class="font-medium text-sm">{{ $car['specs']['engine'] }}</p>
>>>>>>> ae3eca91d202169d17a06e35ad479d823d1102e2
                            </div>
                        </div>
                        <div class="flex items-center gap-3 p-4 bg-secondary/50 rounded-xl">
...
=======
                                <p class="font-medium text-sm">{{ $car['specs']['power'] }}</p>
>>>>>>> ae3eca91d202169d17a06e35ad479d823d1102e2
                            </div>
                        </div>
                        <div class="flex items-center gap-3 p-4 bg-secondary/50 rounded-xl">
...
=======
                                <p class="font-medium text-sm">{{ $car['specs']['fuel'] }}</p>
>>>>>>> ae3eca91d202169d17a06e35ad479d823d1102e2
                            </div>
                        </div>
                        <div class="flex items-center gap-3 p-4 bg-secondary/50 rounded-xl">
...
=======
                                <p class="font-medium text-sm">{{ $car['specs']['seats'] }} chỗ</p>
>>>>>>> ae3eca91d202169d17a06e35ad479d823d1102e2
                            </div>
                        </div>
                    </div>
