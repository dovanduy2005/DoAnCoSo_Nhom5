...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.contracts.preview', $contract) }}" class="flex items-center gap-2 bg-secondary hover:bg-muted px-4 py-2 rounded-lg font-medium text-sm transition-all border shadow-sm">
